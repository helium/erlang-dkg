...
public_key_share_test(Config) ->
    ...
    CommitmentMatrix = dkg_commitmentmatrix:new(Generator, RandomBiPoly),
    ct:pal("CommitmentMatrix: ~p~n", [dkg_commitmentmatrix:print(CommitmentMatrix)]),
...
matrix_comparison_test(Config) ->
    ...
    ct:pal("CommitmentMatrix1: ~p~n", [dkg_commitmentmatrix:print(CommitmentMatrix1)]),
    ...
    ct:pal("CommitmentMatrix2: ~p~n", [dkg_commitmentmatrix:print(CommitmentMatrix2)]),
